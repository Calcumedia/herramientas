...
assert.match(airQuality,/version:'4\.17\.0'/);
...
assert.match(situation,/data\.version='4\.17\.0'/);
...
assert.match(infoca,/version:'4\.17\.0'/);
...
assert.match(bombers,/version:'4\.17\.0'/);
...
assert.match(infoar,/version:'4\.17\.0'/);
...
assert.match(weather,/version:'4\.17\.0'/);
assert.equal(JSON.parse(pkg).version,'4.17.0');
...
assert.equal(JSON.parse(lock).version,'4.17.0');
...
console.log('Source integrity checks passed for FuegoCerca 4.17.0.');
