...
assert.match(health,/integratedRegionalTerritories:7/);
...
assert.match(health,/infomurOfficialUpdates:true/);
assert.match(health,/infomurDirectIntegration:false/);
assert.match(health,/infomurRuntimeBlocked:true/);
assert.match(health,/infomurAbsenceConfirmsSafety:false/);
assert.match(health,/infomurSourceUrl:'https:\/\/noticias\.112rmurcia\.es\/'/);
...
assert.match(situation,/\['Región de Murcia'.*'updates'/);
assert.match(situation,/no se usan para confirmar incendios/);
