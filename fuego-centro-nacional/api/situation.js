...
export default async function handler(request){
  ...
  try{
    ...
    return new Response(JSON.stringify({version:'4.10.1',dataEngineVersion:'4.3.1',degraded:true,error:String(error.message||error),regionalCoverage:DIRECTORY,incidents:[],archive:[],alerts:[],thermalSignals:[],news:[],coverage:[]}),{status:503,headers});
  }
}
